...
// ⚠️ Asegúrate de que barberAuth y barberDb se exporten correctamente
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (rememberMe) {
                ...
                // Limpiar si no se selecciona "Recordar cuenta"
            ...
            // 🥳 NAVEGACIÓN EXITOSA (SOLO si no está vencido)
            navigate(DASHBOARD_PATH, { replace: true });
