...
export const BarberHeader: React.FC = () => {
    ...
    const getSectionTitle = () => {
        ...
        if (path.includes("configuracion")) return "Configuración"; // Añadido
            ...
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    <nav className="py-2 max-h-[400px] overflow-y-auto custom-scrollbar">
                        ...
                        <div className="border-t border-slate-700 my-1"></div>
                        <button onClick={() => goTo("/barber-manager/configuracion")} className="cursor-pointer w-full px-4 py-2 flex items-center gap-2 text-left hover:bg-slate-800 transition-colors">
                            <IconBox><IconSettings /></IconBox> Configuración
                        </button>
